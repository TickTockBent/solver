...
The point is to map the cost/accuracy frontier across compositions of cheap
building blocks and find the undominated points, not to tune one pipeline.
...
- **Frontier competitors:** nearest-neighbor (~25% over), **space-filling curve**
  (~25%, O(n log n); the cheap near-linear competitor and the "cheap big
